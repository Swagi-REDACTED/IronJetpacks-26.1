...
public class ModJetpacks {
    private static final Jetpack WOOD = JetpackRegistry.createJetpack("wood", 0, 0x6B511F, 1, 15,
            "tag:minecraft:planks");
    private static final Jetpack STONE = JetpackRegistry.createJetpack("stone", 1, 0x7F7F7F, 2, 12, "minecraft:stone");
    private static final Jetpack IRON = JetpackRegistry.createJetpack("iron", 2, 0xC1C1C1, 3, 9,
            "minecraft:iron_ingot");
    private static final Jetpack GOLD = JetpackRegistry.createJetpack("gold", 3, 0xDEDE00, 2, 25,
            "minecraft:gold_ingot");
    private static final Jetpack DIAMOND = JetpackRegistry.createJetpack("diamond", 4, 0x4AEDD1, 4, 10,
            "minecraft:diamond");
    private static final Jetpack EMERALD = JetpackRegistry.createJetpack("emerald", 5, 0x41F384, 4, 15,
            "minecraft:emerald");
    private static final Jetpack NETHERITE = JetpackRegistry.createJetpack("netherite", 6, 0x382013, 5, 15,
            "minecraft:netherite_ingot");
    private static final Jetpack CREATIVE = JetpackRegistry.createJetpack("creative", 0, 0xCF1AE9, 8, 0, "null")
            .setCreative();

    private static final Jetpack COPPER = JetpackRegistry.createJetpack("copper", 1, 0xCE7201, 2, 12,
            "minecraft:copper_ingot");
    private static final Jetpack BRONZE = JetpackRegistry.createJetpack("bronze", 2, 0xEC9E3F, 3, 9,
            "techreborn:bronze_ingot");
    private static final Jetpack SILVER = JetpackRegistry.createJetpack("silver", 2, 0x9FC4DD, 3, 12,
            "techreborn:silver_ingot");
    private static final Jetpack STEEL = JetpackRegistry.createJetpack("steel", 3, 0x565656, 3, 15,
            "techreborn:steel_ingot");
    private static final Jetpack ELECTRUM = JetpackRegistry.createJetpack("electrum", 3, 0xA79135, 2, 18,
            "techreborn:electrum_ingot");
    private static final Jetpack INVAR = JetpackRegistry.createJetpack("invar", 3, 0x929D97, 3, 15,
            "techreborn:invar_ingot");
    private static final Jetpack PLATINUM = JetpackRegistry.createJetpack("platinum", 4, 0x6FEAEF, 4, 12,
